...
{{--        <li class="nav-item dropdown">--}}
{{--            <a class="nav-link" data-toggle="dropdown" href="#">--}}
{{--                @if(session()->get('lang') == 'vi' || \App::getLocale() == 'vi')--}}
...
{{--                <a href="{{ route('lang',['vi']) }}" class="dropdown-item {{(session()->get('lang') == 'vi' || \App::getLocale() == 'vi')?'active':''}}">--}}
{{--                    <i class="flag-icon flag-icon-vn mr-2"></i> VI--}}
{{--                </a>--}}
{{--                <a href="{{ route('lang',['en']) }}" class="dropdown-item {{(session()->get('lang') == 'en')?'active':''}}">--}}
